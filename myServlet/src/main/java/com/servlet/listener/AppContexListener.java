...
import com.servlet.util.DBConnectionManager;
...
@WebListener
@WebInitParam(name="dbURL", value="jdbc:mysql://localhost:3306/javatraining")
public class AppContexListener  implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
            ...
            System.out.println("DB Connection initialized OK!!");
